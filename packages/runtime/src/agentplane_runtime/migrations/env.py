"""Alembic environment: async-capable, no ``alembic.ini`` (SPEC §6).

Normally driven programmatically by ``agentplane_runtime.migrate`` with a live
...
from agentplane_runtime.db import Base
from agentplane_runtime.migrate import VERSION_TABLE
